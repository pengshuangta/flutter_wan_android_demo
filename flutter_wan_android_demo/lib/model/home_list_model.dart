...
@JsonSerializable()
  class HomeListModel extends Object {
  ...
  HomeListModel(this.data,this.errorCode,this.errorMsg,);

  factory HomeListModel.fromJson(Map<String, dynamic> srcJson) => _$HomeListModelFromJson(srcJson);
